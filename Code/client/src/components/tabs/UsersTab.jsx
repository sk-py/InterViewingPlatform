...
function UsersTab() {
    ...
    const { setStatus, setisLoggedIn } = useAppContext()
        ...
        <div className="flex flex-col p-4" style={{ height: tabHeight }}>
            ...
            <div className="flex flex-col items-center gap-4 pt-4">
                <div className="flex w-full gap-4">
                    {/* Share URL button */}
                    <button
                        className=" btn flex flex-grow justify-center rounded-md bg-white p-3 text-black"
                        onClick={shareURL}
                        title="Share Link"
                    >
                        <Export size={26} />
                    ...
                    {/* Leave room button */}
                    <button
                        className="btn flex flex-grow justify-center rounded-md bg-primary p-3 text-black"
                        onClick={leaveRoom}
                        title="Leave room"
                    >
                        <SignOut size={26} />
